  ...
  constructor() {
    super({
      metadata: new ChartMetadata({
        name: t('Control Chart (Epidemic Channel)'),
        description: t(
          'Statistical process control chart for anomaly and outbreak detection. ' +
            'Supports Mean±SD, Q3, and C-SUM methods with visual breach alerting.',
        ),
        thumbnail,
        tags: [
          t('Health'),
