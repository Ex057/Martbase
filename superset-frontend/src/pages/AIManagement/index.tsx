...
function normalizeSingleSelectValue(value: SelectValue): string | null {
...
function normalizeMultiSelectValue(value: SelectValue): string[] {
              ...
              <Form layout="vertical">
                ...
                <Form.Item label={t('Default provider')}>
                  <Select
                    ...
                    onChange={value => {
                      const providerId = normalizeSingleSelectValue(value);
                ...
                <Form.Item label={t('Default model')}>
                  <Select
                    ...
                    onChange={value => {
                      const modelId = normalizeSingleSelectValue(value);
              ...
              <Form layout="vertical">
                ...
                >
                  <Select
                    ...
                    onChange={value =>
                      updateSettings({
                        allowed_roles: normalizeMultiSelectValue(value),
                      })
                    }
                  />
                </Form.Item>
                          ...
                          onChange={value =>
                            updateSettings({
                              mode_roles: {
                                ...
                                [mode]: normalizeMultiSelectValue(value),
                              },
                            })
                          }
                        />
                  ...
                  <Form layout="vertical">
                    ...
                    >
                      <Select
                        ...
                        onChange={value => {
                          const models = normalizeMultiSelectValue(value);
                          updateProvider(providerId, {
                            models,
                            default_model: models.includes(
