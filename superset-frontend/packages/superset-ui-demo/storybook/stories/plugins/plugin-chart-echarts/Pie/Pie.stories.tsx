...
// Verification story for the shared Auto subtitle feature. Renders a real Pie
// through SuperChart (which camelCases formData exactly as the app does) with
// the auto-subtitle checkbox on and two adhoc filters, so the ECharts title
// subtext is generated by getChartTitleOption → buildFilterSubtitle.
export const AutoSubtitlePie = (
  ...
  <SuperChart
    ...
    formData={{
      ...
      showLabels: true,
      showLegend: false,
      chart_title: 'Air time by weekday',
